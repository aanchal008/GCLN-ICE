...
def run_code2inv_problem(i):
    ...
    max_epoch = 4000
    I = None
    problem_dataframe = pd.read_csv("../benchmarks/code2inv/traces_with_targets/" + str(i) + ".csv")
    ...
    while (solved == False):
        ...
        solved, I = gcln_infer(i, problem_dataframe, max_epoch=max_epoch, non_loop_invariant=None) 
